...
class MYONLINECARDGAME_API UMyUserWidgetWithCurveUpdaterCardGameScreenPositionRelatedCpp : public UMyWithCurveUpdaterTransformWidget2DBoxWidgetBaseCpp, public IMyCardGameScreenPositionRelatedWidgetInterfaceCpp
{
    GENERATED_BODY()
...
public:
    ...
    IMyCardGameScreenPositionRelatedWidgetInterfaceCpp_DefaultImplementationForUObject();
