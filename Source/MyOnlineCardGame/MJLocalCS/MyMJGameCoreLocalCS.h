...
protected:
    ...
    static void genBaseFromPusherResetGame(FMyMJGameResManager& RM, const FMyMJGamePusherResetGameCpp &pusherReset, const FMyMJDataStructCpp &BaseBefore, FMyMJDataStructCpp &outBase);
